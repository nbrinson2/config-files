...
alias cdbank="cd ~/workspace/ttb/banking-management-service-api"
alias cdcertmanager="cd ~/workspace/ttb/certmanager"
alias cdchem="cd ~/workspace/ttb/chemist-certificate-data-management-api"
alias cdci="cd ~/workspace/ttb/ci-pipeline-library"
alias cdclaims="cd ~/workspace/ttb/claims-management-service-api"
alias cdcontent="cd ~/workspace/ttb/content-management-api"
alias cddocs="cd ~/workspace/ttb/documentation"
alias cdexport="cd ~/workspace/ttb/export-certificate-data-management-api"
alias cdfonl="cd ~/workspace/ttb/fonl"
...
alias cdgitops="cd ~/workspace/ttb/gitops-predev"
alias cdidam="cd ~/workspace/ttb/idam-management-api"
alias cdict="cd ~/workspace/ttb/TTB_ICT_Backend"
alias cdimdata="cd ~/workspace/ttb/im-data-management-api"
alias cdimdsapi="cd ~/workspace/ttb/ttb_imds_backend"
alias cdimdsauth="cd ~/workspace/ttb/IMDS_Auth"
alias cdimdsbe="cd ~/workspace/ttb/IMDS_Backend"
alias cdimdsfe="cd ~/workspace/ttb/IMDS_Frontend"
alias cdims="cd ~/workspace/ttb/ims2"
alias cdintake="cd ~/workspace/ttb/intake-token-service-api"
alias cdintakedata="cd ~/workspace/ttb/intake-data-management-api"
alias cditds="cd ~/workspace/ttb/itds-data-management-api"
alias cdlogs="cd ~/workspace/ttb/logs"
alias cdmain="cd ~/workspace/ttb/my-ttb-main"
alias cdmessaging="cd ~/workspace/ttb/messaging-data-management-api"
alias cdmnbpauth="cd ~/workspace/ttb/MNBP_Auth"
alias cdmnbpbe="cd ~/workspace/ttb/MNBP_Backend"
alias cdmnbpfe="cd ~/workspace/ttb/MNBP_Frontend"
alias cdmock="cd ~/workspace/ttb/mock-ponl-service-api"
...
alias killservices="cd ~/workspace/ttb/util && ./kill-services.sh"
alias mainjava="./mvnw -P-webapp jacoco:prepare-agent-integration verify jacoco:report"
alias pullall="cd ~/workspace/ttb/util && ./git_pull_all_repos.sh"
alias runservices="cd ~/workspace/ttb/util && ./run_services.sh"
alias tf="testfile"
